                  ...
                  <div class="item icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92.3 93.1" fill="currentColor">
                      <g>
                        ...
                        <rect x="45.7" y="0" transform="matrix(0.8412 -0.5407 0.5407 0.8412 -17.8476 32.3497)" class="st0" width="1" height="93.1"></rect>
                        <rect x="45.7" y="0" transform="matrix(0.4155 -0.9096 0.9096 0.4155 -15.3764 69.2119)" class="st0" width="1" height="93.1"></rect>
                        <rect x="-0.4" y="46.1" transform="matrix(0.9898 -0.1425 0.1425 0.9898 -6.1646 7.0506)" class="st0" width="93.1" height="1"></rect>
                        <rect x="-0.4" y="46.1" transform="matrix(0.7556 -0.655 0.655 0.7556 -19.2157 41.618)" class="st0" width="93.1" height="1"></rect>
                        <rect x="-0.4" y="46.1" transform="matrix(0.2812 -0.9597 0.9597 0.2812 -11.5032 77.7858)" class="st0" width="93.1" height="1"></rect>
                        <rect x="45.7" y="0" transform="matrix(0.9595 -0.2817 0.2817 0.9595 -11.2479 14.8866)" class="st0" width="1" height="93.1"></rect>
                        <rect x="45.7" y="0" transform="matrix(0.6549 -0.7557 0.7557 0.6549 -19.2631 50.9572)" class="st0" width="1" height="93.1"></rect>
                        <rect x="45.7" y="0" transform="matrix(0.1423 -0.9898 0.9898 0.1423 -6.4999 85.629)" class="st0" width="1" height="93.1"></rect>
                        <rect x="-0.4" y="46.1" transform="matrix(0.9097 -0.4153 0.4153 0.9097 -15.1716 23.381)" class="st0" width="93.1" height="1"></rect>
                        <rect x="-0.4" y="46.1" transform="matrix(0.5411 -0.8409 0.8409 0.5411 -17.9774 60.1901)" class="st0" width="93.1" height="1"></rect>
                      </g>
                    </svg>
                  </div>
                  <!-- single item -->
                  ...
                  <div class="item icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 89.2 82.8" fill="currentColor">
                      <g>
                        ...
                        <rect x="2.5" y="10.2" transform="matrix(0.9712 -0.2384 0.2384 0.9712 -1.2518 11.1229)" class="st0" width="85.7" height="1"></rect>
                        <rect x="2.5" y="30.7" transform="matrix(0.9712 -0.2384 0.2384 0.9712 -6.1265 11.7116)" class="st0" width="85.7" height="1"></rect>
                        <rect x="2.5" y="51.2" transform="matrix(0.9712 -0.2384 0.2384 0.9712 -11.0059 12.3009)" class="st0" width="85.7" height="1"></rect>
                        <rect x="2.5" y="71.6" transform="matrix(0.9712 -0.2384 0.2384 0.9712 -15.8827 12.8923)" class="st0" width="85.7" height="1"></rect>
                      </g>
                    </svg>
                  </div>
                  <!-- single item -->
                  ...
                  <div class="stack-wrapper">
                    ...
                    <div class="portfolio-stack">
                      ...
                      <div class="stack-item">
                        <div data-mfp-src="#portfolio-popup-1" class="portfolio-stack__inner popup-trigger" style="background-image: url('assets/img/works/mcdonalds/ddb-wb.webp');">
                      ...
                      <!-- portfolio stack single item -->
                      <div class="stack-item">
                        <div data-mfp-src="#portfolio-popup-2" class="portfolio-stack__inner portfolio-item-2 popup-trigger" style="background-image: url('assets/img/works/illustrations/cover2.webp');">
                          <div class="portfolio-stack__descr w-75">
                      ...
                      <!-- portfolio stack single item -->
                      <div class="stack-item">
                        <div data-mfp-src="#portfolio-popup-3" class="portfolio-stack__inner portfolio-item-3 popup-trigger" style="background-image: url('assets/img/works/sensitive/wbss.webp');">
                          <div class="portfolio-stack__descr w-75">
                      ...
                      <!-- portfolio stack single item -->
                      <div class="stack-item">
                        <div data-mfp-src="#portfolio-popup-4" class="portfolio-stack__inner portfolio-item-4 popup-trigger" style="background-image: url('assets/img/works/sipner/sipwb.webp');">
                    ...
                    <div class="col-12">
                      <div class="project">
                        ...
                        <div class="project__block no-padding no-margin project-image-bg">
                          <img class="project-image-bg__portrait" src="assets/img/works/mcdonalds/ddb-wb.webp" alt="Project Illustration">
                          <img class="project-image-bg__landscape" src="assets/img/works/mcdonalds/ddb-wb.webp" alt="Project Illustration">
                          ...
                          <div class="project__descr">
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                ...
                                <div class="col-12 col-xl-8">
                                  <p class="type-basic-160lh">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates sequi
                              ...
                              <div class="row g-0">
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/Charity-2023-3.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/Charity-2023-4.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="project__illustrations">
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/novruz-illustrasiya-su.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/novruz-illustrasiya-od.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="project__illustrations">
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/novruz-illustrasiya-yel.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/novruz-illustrasiya-torpaq.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="project__illustrations">
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/Nesimi-Mall_opening-2.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/Nesimi-Mall_opening-3.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="project__illustrations">
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/back-to-school-4.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/books-mcd-3.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-4 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/Packed-Burger-Mockup.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-4 grid-item">
                                  <div class="project__illustration">
                                ...
                                <div class="col-12 col-md-4 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/breakfast-1200x1200.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="project__illustrations">
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/McCrispy1-1920x1080-RGB.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/McCrispy-1920x1080-RGB-KV.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-3 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/McSunday-dessert.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-3 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/McFlurry-dessert.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-3 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/McFlurry-t-shirt-copy.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-3 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/mcdonalds/McSandey-t-shirt-2-edittt.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                                  ...
                                  <div class="project__feedback">
                                    <div class="feedback__fauthor d-flex">
                                      <div class="fauthor__avatar me-0">
                                        <img class="h-100 object-fit-contain" src="assets/img/client/ddb-logo.webp" alt="Review Author">
                                      </div>
                  ...
                  <div class="row g-0">
                    <div class="col-12">
                      <div class="project">
                        <!-- Project Block - Title with Image Start -->
                        <div class="project__block no-padding no-margin project-image-bg">
                          <img class="project-image-bg__portrait" src="https://dummyimage.com/600x800/4d4d4d/636363" alt="Project Illustration">
                          <img class="project-image-bg__landscape" src="assets/img/works/illustrations/cover1.webp" alt="Project Illustration">
                          <div class="project__title">
                            ...
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-md-6 col-xl-4 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/illustrations/binacopy.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 col-xl-4 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/illustrations/bubbllecopy.webp" alt="Work Illustration">
                                  </div>
                                </div>
                                <div class="col-12 col-md-6 col-xl-4 grid-item">
                                  <div class="project__illustration">
                                    <img src="assets/img/works/illustrations/gizcopy.webp" alt="Work Illustration">
                                  </div>
                                </div>
                              </div>
                            </div>
                                ...
                                <div class="col-12 col-xl-10">
                                  <div class="project__feedback">
                                    <div class="feedback__descr mt-0">
                                      <p class="type-basic-160lh">A surreal exploration of light and shadow, where sunlight reflection reveals a hidden, reversed world.</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                ...
                <div class="row g-0">
                  <div class="col-12">
                    <div class="project">
                      ...
                      <div class="project__block no-padding no-margin project-image-bg">
                        <img class="project-image-bg__portrait" src="https://dummyimage.com/600x800/4d4d4d/636363" alt="Project Illustration">
                        <img class="project-image-bg__landscape" src="assets/img/works/sensitive/wbss.webp" alt="Project Illustration">
                        <div class="project__title">
                            ...
                            <div class="row g-0">
                              <div class="col-12 grid-item">
                                <p class="type-basic-160lh">
                                  "Sensitive wine and chocolate" brand represents sensitive sensations in chocolate and wine. The Scottish brand operates as a specialty wine and chocolate store. The activities of the store include music. When you buy any product from the store, you are given a QR code on the label. When you scan this code, you listen to the music that was given to you. You can choose the music you want. The brand is divided into 3 styles: night, sun and sunset. The feelings represented by the 3 styles are shown to you through illustrations. Red wine represents the harshness of the night, white wine represents the warmth of the sun and rose wine represents the softness of the sunset. In chocolates, mint chocolate represents a cool night, dark chocolate represents a warm sun, and milk chocolate represents a soft sunset.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="container-fluid p-0">
                            <div class="row g-0">
                              <div class="col-12 col-md-3 grid-item mt-0">
                                <div class="project__illustration">
                                  <img src="assets/img/works/sensitive/sensitivve-post-4.webp" alt="Work Illustration">
                                </div>
                              </div>
                              <div class="col-12 col-md-3 grid-item mt-0">
                                <div class="project__illustration">
                                  <img src="assets/img/works/sensitive/sensitivve-post1.webp" alt="Work Illustration">
                                </div>
                              </div>
                              <div class="col-12 col-md-3 grid-item mt-0">
                                <div class="project__illustration">
                                  <img src="assets/img/works/sensitive/sensitivve-post-3.webp" alt="Work Illustration">
                                </div>
                              </div>
                              <div class="col-12 col-md-3 grid-item mt-0">
                                <div class="project__illustration">
                                  <img src="assets/img/works/sensitive/sensitivve-post-2.webp" alt="Work Illustration">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="container-fluid p-0">
                            <div class="row g-0">
                              ...
                              <div class="col-12 col-xl-10">
                                <div class="project__feedback">
                                  <div class="feedback__descr mt-0">
                                    <p class="type-basic-160lh">"Sensitive wine and chocolate" brand represents sensitive sensations in chocolate and wine.</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="row g-0">
                    <div class="col-12">
                      <div class="project">
                        ...
                        <div class="project__block no-padding no-margin project-image-bg">
                          <img class="project-image-bg__portrait" src="https://dummyimage.com/600x800/4d4d4d/636363" alt="Project Illustration">
                          <img class="project-image-bg__landscape" src="assets/img/works/sipner/sipwb.webp" alt="Project Illustration">
                          <div class="project__title">
                            ...
                            <div class="container-fluid p-0">
                              <div class="row g-0">
                                <div class="col-12 col-xl-8 grid-item">
                                  <p class="type-basic-160lh">A series of vibrant coffee illustrations crafted for Sipner Square’s mobile app, bringing the brand's unique coffee flavors to life through engaging visuals.</p>
                                </div>
                              </div>
                            </div>
                          </div>
                                  ...
                                  <div class="project__feedback">
                                    <div class="feedback__fauthor d-flex">
                                      <div class="fauthor__avatar">
                                        <img src="assets/img/works/sipner/sipner-logo.webp" alt="Review Author">
                                      </div>
                                      <div class="fauthor__info d-flex flex-column justify-content-center">
                    ...
                    <div class="row g-0 justify-content-between">
                      ...
                      <div class="col-12 col-md-8 col-lg-7 col-xxl-8 grid-item about-descr pre-title">
                        <p class="about-descr__text type-basic-160lh animate-in-up">
                          ...
                          I specialize in creating visually compelling designs that tell a story. My expertise spans a variety
                          of mediums, from digital illustrations to branding and print design. I am passionate about blending
                        ...
                        <div class="btn-group about-descr__btnholder animate-in-up">
                          <a class="btn btn-default hover-default" href="assets/pdfs/NARGIZ_IBRAHIMOVA_GRAPHIC_DESIGNER_CV.pdf" download="NARGIZ_IBRAHIMOVA_GRAPHIC_DESIGNER_CV.pdf" target="_blank">
                            <em></em>
                  ...
                  <div class="container-fluid p-0">
                    <div class="row g-0">
                      <div class="col-12 grid-item">
                        ...
                        <div class="divider divider-image animate-in-up" style="background-image: url('assets/img/avatars/cv-photo.webp');"></div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="container-fluid p-0 resume-lines">
                    ...
                    <div class="row g-0 resume-lines__item">
                      ...
                      <div class="col-12 col-md-4 col-lg-5">
                        ...
                        <a class="resume-lines__source link-small-underline animate-in-up" href="#0" target="_blank">Baku Design Academy</a>
                      </div>
                      <div class="col-12 col-md-4 col-lg-5">
                        <p class="resume-lines__descr type-basic-160lh animate-in-up">Intensive drawing courses that present the fundamental principles of drawing.</p>
                      </div>
                    </div>
                    <div class="resume-divider animate-in-up"></div>
                    <!-- resume single item -->
                    <div class="row g-0 resume-lines__item">
                      ...
                      <div class="col-12 col-md-4 col-lg-5">
                        ...
                        <a class="resume-lines__source link-small-underline animate-in-up" href="#0" target="_blank">Art college of the Azerbaijan State Academy of Arts</a>
                      </div>
                      <div class="col-12 col-md-4 col-lg-5">
                        <p class="resume-lines__descr type-basic-160lh animate-in-up">Research, design, and prototype effective, visually-driven
                          websites and apps.</p>
                      </div>
                    </div>
                    <div class="resume-divider animate-in-up"></div>
                ...
                <div class="content__block pre-text-items">
                  ...
                  <div class="container-fluid p-0 resume-lines">
                    ...
                    <div class="row g-0 resume-lines__item">
                      ...
                      <div class="col-12 col-md-4 col-lg-5">
                        <p class="resume-lines__descr type-basic-160lh animate-in-up">I created original images for a range of digital
                  ...
                  <div class="tools-cards d-flex justify-content-start flex-wrap">
                    ...
                    <div class="tools-cards__item d-flex grid-item animate-card-4">
                      <div class="tools-cards__card">
                        <img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-photoshop.svg" alt="Tools Icon">
                    ...
                    <div class="tools-cards__item d-flex grid-item animate-card-4">
                      <div class="tools-cards__card">
                        <img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-illustrator.svg" alt="Tools Icon">
                    ...
                    <div class="tools-cards__item d-flex grid-item animate-card-4">
                      <div class="tools-cards__card">
                        <img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-indesign.svg" alt="Tools Icon">
                ...
                <div class="content__block grid-block">
                  <ul class="socials-cards d-flex justify-content-start flex-wrap">
                    ...
                    <li class="socials-cards__item grid-item d-flex animate-card-5">
                      <a class="socials-cards__link d-flex align-items-center justify-content-center" href="https://www.behance.net/nargizibrahimova" target="_blank">
                        <em></em>
                    ...
                    <!-- socials cards single item -->
                    <li class="socials-cards__item grid-item d-flex animate-card-5">
                      <a class="socials-cards__link d-flex align-items-center justify-content-center" href="https://www.linkedin.com/in/nargizradjabqizi-3a4402223/" target="_blank">
                        <em></em>
                    ...
                    <!-- socials cards single item -->
                    <li class="socials-cards__item grid-item d-flex animate-card-5">
                      <a class="socials-cards__link d-flex align-items-center justify-content-center" href="https://www.instagram.com/nargiziibrahimova/" target="_blank">
                        <em></em>
                        ...
                        <div class="content__block pre-grid-items">
                          ...
                          <div class="footer__link d-flex flex-column flex-md-row justify-content-md-between align-items-md-center">
                            ...
                            <div class="footer__btn animate-in-up">
                              <a href="mailto:example@example.com?subject=Message%20from%20your%20site" class="btn btn-circle-icon hover-circle">
                                <em></em>
                          ...
                          <div class="container-fluid p-0 contact-data">
                            <div class="row g-0">
                              ...
                              <div class="col-12 col-md-4 col-lg-3 contact-data__item grid-item">
                                ...
                                <p class="contact-data__text small type-basic-160lh">
                                  <a class="link-small-160lh animate-in-up" href="tel:+994557505889">+994 55 750 58 89</a>
                                </p>
                              </div>
                              <div class="col-12 col-md-4 col-lg-3 contact-data__item grid-item">
